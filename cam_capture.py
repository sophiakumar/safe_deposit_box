...
def capture_image_from_cam_into_temp():
    ...
    while True:
        ...
        if k % 256 == 27:
            ...
            # SPACE pressed
            if not os.path.isdir("C:/Users/Sophia/Desktop/New folder"):
                os.mkdir("C:/Users/Sophia/Desktop/New folder", mode=0o777)  # make sure the directory exists
...
def empty_temp_folder():
    folder = "C:/Users/Sophia/Desktop/New folder"
